...
print("First Sequence is: {}".format(seq1))
print("Length is: {}".format(Seq.len(seq1)))
...
print("Second Sequence is: {}".format(seq2))
print("Length is: {}".format(Seq.len(seq2)))
...
print("Third Sequence is: {}".format(seq3))
print("Length is: {}".format(Seq.len(seq3)))
...
print("Fourth Sequence is: {}".format(seq4))
print("Length is: {}".format(Seq.len(seq4)))
